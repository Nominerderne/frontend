...
#     202: "Амжилттай заслаа.",
#     203: "Амжилттай устгалаа.",
#     204: "Амжилттай засварлалаа.",
#     400: 'Буруу хүсэлт',
#     404: "Олдсонгүй",
...
#     3008: "Бүртгэлтэй хэрэглэгч байна.",
#     3008: "Бүртгэлтэй хэрэглэгч байна.",
...
#     3029: "", 
#     3030: "", 
#     4000: "Нэвтрэлт шаардлагатай, эсвэл буруу.",
#     4001: "Хэрэглэгчийн нэр, нууц үг буруу байна.",
#     5000: "Сервис дотоод алдаа.",
...
def sendResponse(request, resultCode, data, action="no action"):
    response = {
        ...
        "resultMessage": resultMessages[resultCode],
        "data": data,
        "size": len(data),
        "action": action,
...
resultMessages = {
    200: "Амжилттай", 201: "Амжилттай бүртгэлээ.", 202: "Амжилттай заслаа.",
    203: "Амжилттай устгалаа.", 204: "Амжилттай засварлалаа.", 400: 'Буруу хүсэлт',
    404: "Олдсонгүй", 1000: "Burtgeh bolomjgui. Mail hayag umnu burtgeltei baina",
    1001: "Hereglegch Amjilttai burtgegdlee. Batalgaajuulah mail ilgeegdlee. 24 tsagiin dotor batalgaajuulna.",
    1002: "Login Successful", 1003: "Amjilttai batalgaajlaa", 1004: "Hereglegchiin ner, nuuts ug buruu baina.",
    1005: "edituser success", 1006: "getuserresume success", 1007: "getalluser success",
    3000: "Key дутуу", 3001: "ACTION BURUU", 3002: "METHOD BURUU", 3003: "JSON BURUU",
    3004: "Token-ii hugatsaa duussan. Idevhgui token baina.", 3005: "NO ACTION",
    3006: "Login service key dutuu", 3007: "Register service key dutuu", 3008: "Бүртгэлтэй хэрэглэгч байна.",
    3009: "token buruu esvel hugatsaa duussan", 3010: "Hereglegchiin burtgel batalgaajlaa",
    3011: "Forgot password verified", 3012: "Forgot password huselt ilgeelee",
    3013: "Forgot password user not found", 3014: "Batalgaajsan hereglegch baina. Umnuh burtgeleeree nevterne uu. Mail Link",
    3015: "no token parameter", 3016: "forgot service key dutuu", 3017: "not forgot and register GET token",
    3018: "reset password key dutuu", 3019: "martsan nuuts ugiig shinchille",
    3020: "token buruu baina esvel hugtsaa dussan. Nuust ugiig shinchilj chadsangu",
    3021: "change password service key dutuu ", 3022: "nuuts ug amjilttai soligdloo ",
    3023: "huuchin nuuts ug taarsangui ", 3024: "edituser service key dutuu",
    3025: "getuserresume service key dutuu", 3026: "getalluser service key dutuu",
    4000: "Нэвтрэлт шаардлагатай, эсвэл буруу.", 4001: "Хэрэглэгчийн нэр, нууц үг буруу байна.",
    5000: "Сервис дотоод алдаа.", 5001: "Login service dotood aldaa", 5002: "Register service dotood алдаа",
    5003: "Forgot service dotood алдаа", 5004: "GET method token dotood алдаа",
    5005: "reset password service dotood алдаа", 5006: "change password service dotood алдаа",
    5007: "edituser service dotood алдаа", 5008: "getuserresume service dotood алдаа",
    5009: "getalluser service dotood алдаа"
}
...
def sendMail(recipient, subj, bodyHtml):
    sender_email = "testmail@mandakh.edu.mn"
    sender_password = "Mandakh2"
    html_message = MIMEText(bodyHtml, 'html')
