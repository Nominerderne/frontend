...
class _WatchedHistoryTabState extends State<WatchedHistoryTab> {
  ...
  Future<void> fetchWatchedBooks() async {
    const String apiUrl =
        'http://172.20.10.5:8000/readinghistory/'; // өөрийн backend URL
    try {
      final response = await http.post(
        ...
        body: json.encode({
          ...
          "user_id": 1, // хэрэглэгчийн ID-г динамик утгаар солино
        }),
      );
      ...
      if (responseData['code'] == 200) {
        setState(() {
          watchedBooks = responseData['data'];
          isLoading = false;
        });
      }
    } catch (e) {
    ...
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final String viewedAt = dateFormat.format(
            DateTime.parse(book['viewed_at']),
          );
          return Container(
